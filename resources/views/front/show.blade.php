...
<main class="mx-auto pt-24 pb-12 flex flex-col gap-10 bg-gray-700">
<div class="w-11/12 mx-auto space-y-10">
    <section class=" relative overflow-hidden bg-gray-900 rounded-3xl h-[480px] shadow-2xl">
        <div class="absolute top-0 left-0 w-full h-full z-0 ">
            <img class="object-cover w-full h-full" src="{{ asset('storage/' . $announcement->image) }}" alt="">
        </div>
    </section>
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
        <div class="col-span-8 h-full flex flex-col gap-6">
            <div class="">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xl font-medium text-gray-400">{{ $announcement->created_at->diffForHumans()}}</span>
                </div>
            </div>
            <div class="">
                <h1 class="text-4xl font-unbounded font-bold text-gray-200">{{ $announcement->title }}</h1>
            </div>

            <div class="pt-5">
                <div class="pb-5">
                    <h4 class="text-xl font-medium font-unbounded text-gray-100">About this event</h4>
                </div>
                <div class="w-4/5">
            ...
            <section class="w-8/12 antialiased">
                <div class="space-y-5">
                    <div class="pb-5">
                        <h4 class="text-xl font-medium font-unbounded text-gray-100">Share your thoughts</h4>
                    </div>
                    <form class="" method="post">
                        ...
                        <button type="submit"
                                class="inline-flex items-center py-4 px-8 text-sm font-medium text-center text-white bg-gray-900 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
                            Post comment
                        </button>
                    </form>
                    <div class="pb-5">
                        <h4 class="text-xl font-medium font-unbounded text-gray-100">Comments ({{ $totalComments }})</h4>
                    </div>

                @if($comments->count() > 0)
                    @foreach($comments as $comment)
                    <article class="p-6 text-base bg-white rounded-lg dark:bg-gray-800">
                        <div class="flex justify-between items-center mb-2">
                            <div class="flex items-center gap-2">
                                <div class="w-9 h-9 rounded-full bg-gray-900 flex justify-center items-center text-gray-200">AY</div>
                                <div class="flex flex-col -space-y-1">
                                    <span class="text-sm text-gray-300 font-unbounded">
                                        {{ $comment->name }}
                                    </span>
                                        <time class="text-[10px] text-gray-400 font-unbounded">
                    ...
                    @endforeach
                        @else
                    <p class="text-sm text-gray-300 font-unbounded">There is no comments yet!🫢</p>
                        @endif
                </div>
        ...
        <div class="col-span-4">
            <div class="sticky top-20 flex flex-col gap-5">
                <div class="">
                    <h4 class="text-xl font-medium font-unbounded text-gray-200">Organized by</h4>
                </div>
                <div class="flex items-center gap-5 p-6 bg-gray-900 rounded-xl border border-1 border-gray-700 shadow-md">
                    <div class="relative w-16 h-16 bg-gray-700 rounded-full overflow-hidden shadow-md flex items-center justify-center">
                    ...
                    <div class="flex flex-col">
							<span class="text-lg capitalize font-medium font-unbounded text-gray-200">
								Ali Yara
							</span>
                    </div>
                </div>
